...
public class form_pinjaman extends javax.swing.JPanel {
   ...
   private void CariData() {
    ...
    try {
        String sql = "SELECT * FROM pinjaman_guru WHERE " +
                     "Id LIKE ? OR " +
                     "Nama_Guru LIKE ? OR " +
                     "jenis_pinjaman LIKE ? OR " +
                     "jumlah_pinjaman LIKE ? OR " +
                     "tanggal_pinjam LIKE ? OR " +
                     "tanggal_jatuh_tempo LIKE ?";
    ...
    private void initComponents() {
        ...
        btn_hapus5.setBackground(new java.awt.Color(255, 255, 255));
        ...
        btn_batal6.setBackground(new java.awt.Color(0, 153, 255));
        btn_batal6.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btn_batal6.setForeground(new java.awt.Color(255, 255, 255));
        ...
        data_pinjaman1Layout.setHorizontalGroup(
            ...
            .addGroup(data_pinjaman1Layout.createSequentialGroup()
                ...
                .addGroup(data_pinjaman1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(data_pinjaman1Layout.createSequentialGroup()
                        .addComponent(btn_ubah, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        data_pinjaman1Layout.setVerticalGroup(
            ...
            .addGroup(data_pinjaman1Layout.createSequentialGroup()
                ...
                .addGap(14, 14, 14)
                .addGroup(data_pinjaman1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, data_pinjaman1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel9)
        ...
        jLabel2.setText("Tambah Data Pinjaman");

        btn_ubah1.setBackground(new java.awt.Color(0, 153, 255));
        btn_ubah1.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
                ...
                .addGroup(form_pinjamanLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(form_pinjamanLayout.createSequentialGroup()
                        .addGroup(form_pinjamanLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(form_pinjamanLayout.createSequentialGroup()
                                .addComponent(btn_ubah1, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
        ...
        form_pinjamanLayout.setVerticalGroup(
            ...
            .addGroup(form_pinjamanLayout.createSequentialGroup()
                ...
                .addGroup(form_pinjamanLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btn_ubah1, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    try {
         if (btn_ubah1.getText().equals("UBAH")) {
            // Update data yang sudah ada
            sql = "UPDATE pinjaman_guru SET nama_guru=?, jenis_pinjaman=?, jumlah_pinjaman=?, tanggal_pinjam=?, tanggal_jatuh_tempo=? WHERE Id=?";
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        ...
        if (row >= 0) {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                try {
                    sql = "DELETE FROM pinjaman_guru WHERE Id=?";
                    PreparedStatement pst = cn.prepareStatement(sql);
                    pst.setString(1, id);
                    pst.executeUpdate();
   ...
   int selectedRow = tbldatapinjaman1.getSelectedRow();
    ...
    // Isi data ke form
    tx_Id.setText(id);
    tx_Id.setEditable(false); // agar ID tidak bisa diubah
    ...
    if (row != -1) {
        ...
        btn_ubah.setText("UBAH"); // ganti tombol tambah jadi ubah
    }
