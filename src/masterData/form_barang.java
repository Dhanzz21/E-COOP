...
public final class form_barang extends javax.swing.JPanel {
    ...
    try {
        ...
        tbldataBarang.setModel(model); // tabelBarang adalah JTable buat nampilin data
    ...
    private void initComponents() {
        ...
        tx_namaBarang.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N

        Harga.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        Harga.setText("Harga");

        tx_harga.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        tx_harga.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tx_hargaActionPerformed(evt);
            }
        });
        ...
        tx_stock.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel3)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tx_namaBarang, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(44, 44, 44)
                .addComponent(Harga)
                .addGap(18, 18, 18)
                .addComponent(tx_harga, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(33, 33, 33)
                .addComponent(jLabel5)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tx_stock, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(44, 44, 44))
        );

        javax.swing.GroupLayout form_barangLayout = new javax.swing.GroupLayout(form_barang);
        form_barang.setLayout(form_barangLayout);
        form_barangLayout.setHorizontalGroup(
            form_barangLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(form_barangLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(form_barangLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        form_barangLayout.setVerticalGroup(
            form_barangLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(form_barangLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel2)
                .addGap(14, 14, 14)
                .addGroup(form_barangLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        main_panel.add(form_barang, "card2");
    ...
    if (jawab == JOptionPane.YES_OPTION) {
        try {
            stat = cn.createStatement();
            String sql = "DELETE FROM data_barang WHERE Id='" + tx_Id.getText().trim() + "'";
    ...
    if (tx_Id.getText().equals("") ||
        tx_namaBarang.getText().equals("") ||
        tx_stock.getText().equals("")) {
    ...
    if (btn_simpan.getText().equals("SIMPAN")) {
        ...
        String cek = "SELECT * FROM data_Barang WHERE Id='" + tx_Id.getText() + "'";;
        ...
        if (res.next()) {
            ...
            // Insert data baru
            String sql = "INSERT INTO data_barang VALUES ('" + tx_Id.getText() +
...
//             "','" + cb_status.getSelectedItem().toString() +
            ...
            String edit = "UPDATE data_barang SET nama_Barang = '" + tx_namaBarang.getText() +
                "', harga_Barang = '" + tx_harga.getText() +
                "', Stock = '" + tx_stock.getText() +
    ...
    private void tbldataBarangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbldataBarangMouseClicked
        tx_Id.setText(tbldataBarang.getValueAt(tbldataBarang.getSelectedRow(),0).toString());
        tx_namaBarang.setText(tbldataBarang.getValueAt(tbldataBarang.getSelectedRow(),1).toString());
        tx_harga.setText(tbldataBarang.getValueAt(tbldataBarang.getSelectedRow(),2).toString());
        tx_stock.setText(tbldataBarang.getValueAt(tbldataBarang.getSelectedRow(),3).toString());
    ...
    private void tx_hargaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tx_hargaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tx_hargaActionPerformed
