...
//        tx_Id.setEditable(true);
    ...
    if (jawab == JOptionPane.YES_OPTION) {
        try {
            stat = cn.createStatement();
            String sql = "DELETE FROM data_barang WHERE id_Barang='" + tx_Id.getText().trim() + "'";
    ...
    if (btn_simpan.getText().equals("SIMPAN")) {
        ...
        String cek = "SELECT * FROM data_Barang WHERE id_Barang='" + tx_Id.getText() + "'";;
...
//             "','" + cb_status.getSelectedItem().toString() +
    ...
    private void tbldataBarangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbldataBarangMouseClicked
        ...
        cb_status.setSelectedItem(tbldataBarang.getValueAt(tbldataBarang.getSelectedRow(),2).toString());
